...
function TeamCast() {
    ...
    const players = [
        ...
        { imagem: <img src={Guilherme} alt="foto-gui" />, name: "Gui", number: 10, position: "Ala", games: 10, goals: 15, assists: 5 },
        { imagem: <img src={Matheus} alt="foto-matheus" />, name: "Matheus", number: 11, position: "Ala", games: 9, goals: 16, assists: 8 },
        { imagem: <img src={DefaultAvatar} alt="defaul-avatar" />, name: "Rafa", number: 7, position: "Ala", games: 3, goals: 6, assists: 1 },
        { imagem: <img src={Douglas} alt="foto-doug" />, name: "Doug", number: 13, position: "Pivô", games: 6, goals: 1, assists: 4 },
        { imagem: <img src={DefaultAvatar} alt="default-avatar" />, name: "Guedes", number: 5, position: "Pivô", games: 7, goals: 2, assists: 5 },
        { imagem: <img src={DefaultAvatar} alt="dafault-avatar" />, name: "Lucas", number: "", position: "Pivô", games: 4, goals: 4, assists: 1 },
        { imagem: <img src={Victor} alt="foto-victor" />, name: "Victor", number: 9, position: "Pivô", games: 11, goals: 4, assists: 5 },
    ];
